  ...
  component: () => (
    <CrudPage
      ...
      fields={[
        ...
        { key: "published_at", label: "Published at (ISO datetime)", placeholder: "2026-06-01T10:00:00Z" },
        { key: "published", label: "Published", type: "boolean" },
      ]}
      listColumns={[
        { key: "title", label: "Title" },
        { key: "category", label: "Category" },
        { key: "published_at", label: "Date", render: (r) => r.published_at ? new Date(r.published_at as string).toLocaleDateString() : "—" },
