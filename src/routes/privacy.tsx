  ...
  component: () => (
    <>
      ...
      <section className="container mx-auto max-w-3xl space-y-6 px-4 py-16 text-foreground/90">
        ...
        <p>Name, email, phone, company, the contents of messages you send us, and standard web analytics (pages viewed, referrer, device).</p>
        <h2 className="font-display text-2xl font-bold">How we use it</h2>
        <p>To respond to inquiries, deliver our search and staffing services, and improve our site. We do not sell personal data.</p>
        <h2 className="font-display text-2xl font-bold">Your rights</h2>
        <p>You can request access, correction, or deletion of your personal data at any time by emailing us.</p>
